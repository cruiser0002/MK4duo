...
#ifndef _RESIN_MECHANICS_H_
#define _RESIN_MECHANICS_H_

#if IS_RESIN

  class Resin_Mechanics : public Mechanics {
    ...
    public: /** Public Function */
       ...
       * no kinematic translation. Used for homing axes and resin/core syncing.
       */
       ...
       *
       * For Resin robots this applies one-to-one when an
  ...
  extern Resin_Mechanics mechanics;

#endif // IS_RESIN

#endif /* _RESIN_MECHANICS_H_ */
